...
scene('index', function (score) {
  layers(['bg', 'obj', 'ui'], "obj"); //blueprint map

  var maps = []; //add in the background

  add([sprite(""), pos(), scale(width() / 240, height() / 240), layer("")]); //add the player

  var player = add([sprite('megagirl'), solid(), pos(30, 0), body(), origin(vec2(2, 0.25))]); //add the score
